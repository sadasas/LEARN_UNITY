...
public class TPP_PlayerControl : MonoBehaviour
{
  ...
  [Header("Player Rotation")]
    ...
    private void Start()
    {
        GameEvents.instance.aimPressed += Aiming;
        GameEvents.instance.shootPressed += Aiming;
        GameEvents.instance.jumpPressed += Jump;
    ...
    void Jump() => animator.SetTrigger("IsJump");
    public void JumpEvent() => verticalVelocity += Mathf.Sqrt(jumpHeight * -3f * gravity);
